...
export const getCountryNameForLocale = (countryCode: string) => {
  return countries["en"][countryCode.toUpperCase()];
};

export const languageIdsWithPos = [12, 2, 27, 33, 13, 1, 19, 7, 3, 23, 16, 8, 6, 35, 44, 11, 9, 26, 5, 41, 4, 15, 22];
