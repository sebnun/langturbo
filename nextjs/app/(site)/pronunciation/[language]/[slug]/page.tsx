      ...
      <article className="prose prose-invert md:prose-lg max-w-none my-12">
        ...
        <div className="flex justify-center">
          <Link
            ...
            rel="sponsored"
            className="no-underline py-1 before:block before:content-[''] before:absolute before:h-[1px] before:bg-white before:w-full before:bottom-0 after:bottom-0 relative w-fit block after:block after:content-[''] after:absolute after:h-[1px] after:bg-colorprimary after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-left mx-auto md:mx-0"
          >
