...
export default async function PronunciationLookup() {
  return (
    <main className="max-w-6xl mx-auto p-6">
      <h1 className="font-cormorant-garamond scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl my-6">Choose a language to lookup pronunciation</h1>
